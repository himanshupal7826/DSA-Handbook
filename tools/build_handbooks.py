...
<style>
  ...
  .portal-hero h1{font-size:44px;letter-spacing:-1.5px;margin:0 0 8px}
  .portal-hero .dot{color:var(--accent)}
...
<div class="portal-top">
  <div style="font-weight:800;font-size:18px;display:flex;align-items:center;gap:8px"><span style="width:26px;height:26px;border-radius:7px;background:linear-gradient(135deg,var(--accent),#9333ea);display:grid;place-items:center;color:#fff;font-size:13px">z</span>zariya<span class="dot" style="color:var(--accent)">.in</span></div>
