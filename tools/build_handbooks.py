...
import grpc_golang_hb, redis_caching_hb, messaging_hb
import database_design_hb
SPECS = [django_hb.SPEC, go_hb.SPEC, system_design_hb.SPEC, docker_hb.SPEC,
         ...
         cassandra_hb.SPEC, rest_api_hb.SPEC, grpc_golang_hb.SPEC, redis_caching_hb.SPEC,
         messaging_hb.SPEC, database_design_hb.SPEC]
